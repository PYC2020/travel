...
//专用的测试配置类
@Configuration
@ComponentScan("com.yc.travel.admin")
...
public class DaoConfiguration {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://39.101.129.133:3306/db_travel?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Hongkong");
        dataSource.setUsername("pyc");
    ...
    public static class MyBatisMapperScannerConfig {
        ...
        public MapperScannerConfigurer mapperScannerConfig() {
            ...
            //扫描   针对每个表的mapper位置
            mapperScannerConfigurer.setBasePackage("com.yc.travel.admin.dao.Impl");
            //配置通用mappers
            Properties properties = new Properties();
            //   指定通用mapper的位置，一定不能在   com.yc.piclib.dao.impl
            properties.setProperty("mappers", "com.yc.travel.admin.dao.MisBaseMapper");
