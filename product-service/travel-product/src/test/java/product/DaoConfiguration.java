...
//专用的测试配置类
@Configuration
@ComponentScan("com.yc.product")//不同包重名会报错？？？
...
public class DaoConfiguration {
    ...
    public static class MyBatisMapperScannerConfig {
        ...
        public MapperScannerConfigurer mapperScannerConfig() {
            ...
            //扫描   针对每个表的mapper位置
            mapperScannerConfigurer.setBasePackage("com.yc.product.dao.Impl");
            //配置通用mappers
            Properties properties = new Properties();
            //   指定通用mapper的位置，一定不能在   com.yc.piclib.dao.impl
            properties.setProperty("mappers", "com.yc.product.dao.MisBaseMapper");
